...
/**
 * Incoming body for PUT /drop-ins/{id}. A record = immutable data carrier.
 ...
 *
 * No courtId here — a drop-in's court is immutable once created.
 *
 ...
 */
public record UpdateDropInRequest(
